...
{
    public class ElseOperationViewModel : IOperationViewModel
    {
        ...
        public ElseOperationViewModel(Test test, IEventAggregator eventAggregator)
        {
            this.test = test;
        ...
        private TestItem CreateTestItem()
        {
            ...
            testItem.Operation = new ElseOperation();
            testItem.Test = test;
