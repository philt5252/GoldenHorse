...
{
    public class SetVariableOperationViewModel : IOperationViewModel
    {
        private readonly Test test;
        private AddTestItemEvent addTestItemEvent;
        public Bitmap Icon { get { return null; } }
        public string Name { get { return "Set Variable"; } }
        public ICommand AddToTestCommand { get; protected set; }


        public SetVariableOperationViewModel(Test test, IEventAggregator eventAggregator)
        {
            this.test = test;
